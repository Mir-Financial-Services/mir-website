...
(function () {
  ...
  var COURSE = {
    ...
    lessons: [
      { n: 1,  yt: "UZZoIQXcOqY", len: "", title: "Introduction and course overview",
        desc: "What this course covers and who it is for." },
      { n: 2,  yt: "e0BUNHW06hk", len: "", title: "Entering your company's initial information",
        desc: "Company settings and getting your QuickBooks file ready." },
      { n: 3,  yt: "b8bDJ0xlrL4", len: "", title: "Setting up HST codes",
        desc: "Configuring sales tax and creating your HST codes." },
      { n: 4,  yt: "5BqBKesMJq0", len: "", title: "Creating a customer profile",
        desc: "Adding a customer and recording their details." },
      { n: 5,  yt: "854ndK3_Xt4", len: "", title: "Creating an invoice for a customer",
        desc: "Issuing an invoice and recording the payment received." },
      { n: 6,  yt: "IVtz2MusAdI", len: "", title: "Categorizing bank transactions",
        desc: "Working the For Review tab and sorting transactions." },
      { n: 7,  yt: "ZzA4r4i59Zc", len: "", title: "Bank reconciliation",
        desc: "Matching QuickBooks to your bank statement each month." },
      { n: 8,  yt: "LVyxHa4aHrg", len: "", title: "Reviewing the first month's financial statements",
        desc: "A look at the profit and loss and the balance sheet after month one." },
      { n: 9,  yt: "-YnC04lffDc", len: "", title: "Rules",
        desc: "Creating rules to categorize transactions automatically." },
      { n: 10, yt: "Fnc3dKgffpo", len: "", title: "Reviewing the first quarter's financial statements",
        desc: "Checking the reports after the first three months." },
      { n: 11, yt: "PEQ5jhX7tLw", len: "", title: "End of the introductory course",
